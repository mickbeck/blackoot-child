...
<div class="container" id="main-content">
    ...
    <main id="work">
            <h1 class="lg-heading">
                <i class="fas fa-chevron-left"></i> Themes <i class="fas fa-chevron-right"></i>
            </h1>
            <div class="post-wrapper">
                ...
                <div class="item">
                    <a href="https://mickbeck.github.io/ontel_" target="_blank">
                        <img src="<?php echo get_theme_file_uri();?>/img/raleway-1.jpg" alt="theme-1">
                    </a>
                </div>
                <div class="item">
                    <a href="https://mickbeck.github.io/ontel_" target="_blank">
                        <img src="<?php echo get_theme_file_uri();?>/img/multipro-1.jpg" alt="theme-1">
                    </a>
                </div>
            </div>
    </main>
    <main id="about">
        ...
        <div class="card-wrapper">
            <div class="img-wrapper">
                <img src="<?php echo get_theme_file_uri();?>/img/people.jpg" alt="">
            </div>
